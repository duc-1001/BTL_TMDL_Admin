                    ...
                    <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
                        ...
                        {viewDetail && (
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4 text-sm">
                                    <div>
                                        <p className="text-muted-foreground mb-1">Danh mục áp dụng</p>
                                        <div className="flex flex-wrap gap-2">
                                            {
                                                viewDetail.applyToAllCategories ? (
                                                    <p className="text-xs text-muted-foreground">Tất cả danh mục</p>
                                                ) : (
                                                    viewDetail.applicableCategories.map((cat) => (
                                    ...
                                    <div>
                                        <p className="text-muted-foreground mb-1">Sản phẩm áp dụng</p>
                                        {viewDetail.applicableProducts.length > 0 ? (
                                            <div className="flex flex-wrap gap-2">
                                                {viewDetail.applicableProducts.map((prod) => {
                                                    return (
